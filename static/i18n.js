const translations = {
  uz: {
    ...
    dedup_desc: "Zaryadlovchi va vaqtlari to'qnashgan soxta dublikatlarni aniqlash, 10 talik sahifalarda ko'rish va xavfsiz tozalash.",
    ...
    th_select: "Tanlash",
    th_charger: "충전기 ID (Zaryadlovchi)",
    th_connector: "컨넥터 ID",
    th_begin: "begin (Boshlanish)",
    th_end: "end (Tugash)",
    th_power: "Quvvat",
    th_price: "Narx (Won)",
    ...
    badge_delete: "Dublikat (O'chiriladi)",
    badge_exact_tag: "🔴 Aynan bir xil",
    badge_zero_tag: "🟡 0 Quvvatli",
    badge_overlap_tag: "🔵 Vaqt ustma-ust",
    pagination_showing: "Jami {total} tadan {start}-{end} ko'rsatilmoqda (Har sahifada 10 tadan)",
    ...
    dedup_scanning_spinner: "MariaDB bazasi skanerlanmoqda...",
    dedup_scanning_btn: "⏳ Skanerlanmoqda...",
    dedup_cleaning_btn: "⏳ Tozalanmoqda...",
    dedup_restoring_btn: "⏳ Qaytarilmoqda...",
    backup_modal_title: "📦 O'chirilgan Dublikatlar Zaxira Arxivi",
    backup_modal_sub: "TCSP_CHARGE_HIST_DUPLICATES_BACKUP jadvalidan oxirgi o'chirilgan cheklar va qaytarish",
    btn_restore_selected: "↩️ Asl jadvalga qaytarish (Restore)",
    btn_restore_single: "↩️ Qaytarish",
    btn_filter_backup: "🔍 Qidirish",
    backup_empty_records: "Zaxira jadvalida o'chirilgan dublikatlar topilmadi.",
  ...
  ko: {
    ...
    dedup_desc: "동일 시간대 및 충전기 충돌 중복 데이터를 감지하고 10건 단위로 안전하게 백업/정리합니다.",
    label_scan_date: "날짜:",
    filter_all: "전체",
    filter_exact: "🔴 완전 동일",
    filter_zero: "🟡 0 전력량",
    ...
    th_select: "선택",
    th_charger: "충전기 ID (충전소)",
    th_connector: "커넥터 ID",
    th_begin: "begin (시작 시간)",
    th_end: "end (종료 시간)",
    th_power: "전력량",
    th_price: "금액 (원)",
    th_card: "카드 번호",
    ...
    th_action: "추천 상태",
    badge_keep: "원본 (유지)",
    badge_delete: "중복 (삭제 권장)",
    badge_exact_tag: "🔴 완전 동일",
    badge_zero_tag: "🟡 0 전력량",
    badge_overlap_tag: "🔵 시간 겹침",
    pagination_showing: "총 {total}건 중 {start}-{end}건 표시 (페이지당 10건)",
    empty_no_duplicates: "선택한 기간에 중복 데이터가 없습니다! 데이터가 정상입니다.",
    empty_prompt_scan: "중복 데이터를 스캔하려면 상단의 날짜를 선택하고 '🔍 중복 스캔' 버튼을 클릭하세요.",
    dedup_scanning_spinner: "MariaDB 데이터베이스 스캔 중...",
    dedup_scanning_btn: "⏳ 스캔 중...",
    dedup_cleaning_btn: "⏳ 정리 중...",
    dedup_restoring_btn: "⏳ 복원 중...",
    backup_modal_title: "📦 삭제된 중복 데이터 백업 보관함",
    backup_modal_sub: "TCSP_CHARGE_HIST_DUPLICATES_BACKUP 테이블에서 최근 삭제된 내역을 조회하고 복원합니다",
    btn_restore_selected: "↩️ 원본 테이블로 복원 (Restore)",
    btn_restore_single: "↩️ 복원",
    btn_filter_backup: "🔍 검색",
    backup_empty_records: "백업 보관함에 삭제된 중복 데이터가 없습니다.",
    th_deleted_at: "삭제 일시",
